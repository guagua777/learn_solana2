...
pub struct TransferTokens<'info> {
    ...
    pub token_program: Interface<'info, TokenInterface>, // 用于token相关操作，指定账户的owner为token_program，以及token的转账等操作
    pub associated_token_program: Program<'info, AssociatedToken>, // 用于ATA
    pub system_program: Program<'info, System>, // 用于创建账户
}